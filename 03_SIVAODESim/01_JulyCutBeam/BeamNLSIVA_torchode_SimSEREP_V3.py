...
class Generator(nn.Module):
    def __init__(self, Minv_mat, K_mat, C_mat, f_vec, dof):
    ...
    def system(self, t, y, args):
        ...
        # Extract displacements and velocities. Each of these is size (batch_size,DOF) because we
        ...
        F_total -= torch.einsum("ij,bj->bi", self.Ct, v)
    ...
    def forward(self, features, t_span, disp_initial_batch, vel_initial_batch):
        ...
        C_v = torch.einsum("ij,btj->bti", self.Ct, all_v)
...
generator = Generator(Minv_mat=Minv, K_mat=Kt, C_mat=Ct, f_vec=ft, dof=DOF).to(device)
